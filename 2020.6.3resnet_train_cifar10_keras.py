...
def main():
    ...
    # [b, 32, 32, 3] => [b, 1, 1, 512]
    # model = tf.keras.models.load_model('model_resnet18.h5')
    # model = tf.keras.models.load_model('model_resnet34.h5')
    ...
    # model.load_weights('./checkpoints/resnet18')
    # model.load_weights('./checkpoints/resnet34')
